...
class _SplashScreenState extends State<SplashScreen> {
  ...
  _initialSetup() async {
    ...
    if (_localStorageService.onBoardingPageCount + 1 < onboardingList.length) {
      final List<Image> preCachedImages = [
        ...
        // ),
        // SvgPicture.asset(
        //   onboardingList[_localStorageService.onBoardingPageCount + 1].imgUrl!,
        //   fit: BoxFit.scaleDown,
        //   height: 757.h,
        //   width: 390.w,
        // ),
  ...
  Future<List<Image>> preCacheOnboardingImages(
  ...
  Widget build(BuildContext context) {
    ...
    ///
    return Scaffold(
      body: Center(child: Image.asset("assets/images/ToDologo.png")),
    );
  }
}
